<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <form action="{{ route('books.index') }}" method="GET" class="w-full max-w-lg">
                  ...
                  <div class="flex flex-col px-2 py-2">
                   ...
                   <!-- カラム２ -->
                    <div class="w-full md:w-1/1 px-3 mb-2 md:mb-0">
                      ...
                      <input name="item_area" value="{{$book->item_area}}" class="appearance-none block w-full text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" placeholder="">
                    </div>
                    <!-- カラム３ -->
